jewel.screens["game-screen"] = (function() {
    ...
    function startGame() {
        ...
        if (activeGame) {
            useActiveGame = window.confirm("Do you want to continue previous game?");
        ...
        board.initialize(startJewels, function () {
            display.initialize(function () {
                display.redraw(board.getBoard(), function () {
                    ...
                    // Jesli gracz potwierdzi chec powrotu do gry, przywrocone zostaja wartosci poziomu i wyniku.
                    if (useActiveGame) {
    ...
    function gameOver() {
        ...
        display.gameOver(function () {
            ...
            setTimeout(function () {
                jewel.game.showScreen("highscore", gameState.score);
            }, 2500);
        });
    }
    ...
    function setup() {
        ...
        dom.bind("#game-screen button[name=exit]", "click", function () {
            ...
            var exitGame = window.confirm("Do you want return to main menu?");
